                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            <img src="{{url('frontend/images/members/m1.png')}}" class="member-image mr-1">
                            <img src="{{url('frontend/images/members/m2.png')}}" class="member-image mr-1">
                            <img src="{{url('frontend/images/members/m3.png')}}" class="member-image mr-1">
                            <img src="{{url('frontend/images/members/m4.png')}}" class="member-image mr-1">
                            <img src="{{url('frontend/images/members/m5.png')}}" class="member-image mr-1">
                        </div>
                        <hr>
