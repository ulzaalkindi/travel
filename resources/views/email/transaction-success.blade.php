                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:150px;">
                                                            <img alt="" height="auto"
                                                                src="{{url('frontend/images/logo_nomads@2x.png')}}"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:550px;">
                                                            <img alt="" height="auto"
                                                                src="{{url(Storage::url($data->travel_package->galleries[0]->image))}}"
                                                                style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                                                width="550" />
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <div
                                                                ...
                                                                Hi, {{$data->user->name}} <br><br> Ticket digital kamu
                                                                sudah
                                                        ...
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:right;">{{$item->nationality}}
                                                                    </td>
                                                                </tr>
                                                                @endforeach
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                ...
                                                                <tr>
                                                                    <td><strong>Departure Time</strong>
                                                                    <td style="text-align:right;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Assistant,Helvetica,Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#000000;">
